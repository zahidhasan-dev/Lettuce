                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-4">
                                            <div class="input-item input-item-name ltn__custom-icon billing_details_input_wrap">
                                                ...
                                                <div class="text-danger billing_name_error input_error" style="font-size:14px"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-lg-4">
                                            <div class="input-item input-item-email ltn__custom-icon billing_details_input_wrap">
                                                ...
                                                <div class="text-danger billing_email_error input_error" style="font-size:14px"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-lg-4">
                                            <div class="input-item input-item-phone ltn__custom-icon billing_details_input_wrap number_wrap">
                                                ...
                                                <div class="text-danger billing_phone_error input_error" style="font-size:14px"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6">
                                            ...
                                            <div class="input-item billing_details_input_wrap">
                                                ...
                                                <div class="text-danger billing_country_error input_error" style="font-size:14px"></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6">
                                            ...
                                            <div class="input-item billing_details_input_wrap" id="billig_city_wrap">
                                                ...
                                                <div class="text-danger billing_city_error input_error" style="font-size:14px"></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4 col-md-6">
                                            <h6>Postal code <span class="text-danger">*</span></h6>
                                            <div class="input-item billing_details_input_wrap">
                                                <input type="text" name="billing_zipcode" placeholder="Postal code">
                                                <div class="text-danger billing_zipcode_error input_error" style="font-size:14px"></div>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-6">
                                            <h6>Address <span class="text-danger">*</span></h6>
                                            <div class="input-item billing_details_input_wrap">
                                                <input type="text" name="billing_address" placeholder="House number and street name" value="{{ auth()->user()->userDetails->address ?? '' }}">
                                                <div class="text-danger billing_address_error input_error" style="font-size:14px"></div>
                                            </div>
                                        </div>
                                    </div>
                                    {{-- <p><label class="input-info-save mb-0"><input type="checkbox" name="create_account" value="1"> Create an account?</label></p> --}}
                                    <h6>Order Notes (optional)</h6>
                                    <div class="input-item input-item-textarea ltn__custom-icon" style="margin-bottom:30px;">
                                        <textarea name="order_note" placeholder="Notes about your order, e.g. special notes for delivery." style="margin-bottom:0;"></textarea>
                                        <div class="text-danger order_note_error input_error" style="font-size:14px"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="ltn__checkout-payment-method mt-50">
                                ...
                                <div id="checkout_accordion_1">
                                    <div class="text-danger payment_method_error" style="font-size:14px"></div>
                                    <!-- card -->
                                    <div class="card">
    ...
    <script type="text/javascript">
           ...
           $.ajax({
                ...
                success:function(data){
                    if(data.validation_error){
                        show_validation_error(data.validation_error);
                        form_response = {
                            hasError: true,
                        }
                    }else if(data.quantity_error){
                        showMessage(data.quantity_error);
                        form_response = {
                            hasError: true,
                        }
        ...
        function handleServerResponse(response) {
            if (response.error) {
                ...
                setLoading(false);
                show_validation_error(response.validation_error);
            }else if(response.quantity_error){
                setLoading(false);
                showMessage(response.quantity_error);
