    ...
    <tr>
        ...
        <td>
            <div class="d-flex gap-3">
                <a href="javascript:void(0);" class="text-success contact_email_edit" data-id="{{ $email->id }}" data-bs-toggle="modal" data-bs-target="#editContactEmail" ><i class="mdi mdi-pencil font-size-18"></i></a>
                <a href="javascript:void(0);" class="text-danger contact_email_delete" data-id="{{ $email->id }}" data-bs-toggle="modal" data-bs-target="#deleteContactEmail"><i class="mdi mdi-delete font-size-18"></i></a>
            </div>
        </td>
    </tr>
@empty
